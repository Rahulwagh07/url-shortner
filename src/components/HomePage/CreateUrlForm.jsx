    ...
    <div className="p-8 pb-16 mx-auto flex flex-col gap-3 sm:w-11/12 xs:w-full md:w-10/12 rounded-md shadow-md">
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
       ...
       <div className='w-full relative'>
        ...
        />
        {urlName.length > 0 && (
          <span className="absolute top-0 right-1"> {urlName.length}/15</span>
        )}
      </div>
      ...
      <div className='w-full relative'>
        ...
        {customCharacters.length > 0 && (
          <span className="absolute top-0 right-1">{customCharacters.length}/16</span>
        )}
      </div>
        ...
        />
         {description.length > 0 && (
          <span className="absolute top-0 right-1"> {description.length}/250</span>
        )}
        </div>
        <select
            value={tier}
